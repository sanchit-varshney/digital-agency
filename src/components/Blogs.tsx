  ...
  return (
    <BlogsContainer>
      ...
      <BlogsWrapper>
        <BlogCard>
          <BlogImage
            src={`${process.env.PUBLIC_URL}/images/BlogImage1.png`}
            alt="Blog 1"
          />
          <BlogContent>
            ...
            <BlogDescription>
              ...
              to be. “The results have been incredible.
            </BlogDescription>
            <BlogReadMore>
              <span>Read more</span>
        ...
        <BlogCard>
          <BlogImage
            src={`${process.env.PUBLIC_URL}/images/BlogImage2.png`}
            alt="Blog 2"
          />
          <BlogContent>
            <BlogTitle>Realtime analytics</BlogTitle>
        ...
        <BlogCard>
          <BlogImage
            src={`${process.env.PUBLIC_URL}/images/BlogImage3.png`}
            alt="Blog 3"
          />
          <BlogContent>
            <BlogTitle>Realtime analytics</BlogTitle>
